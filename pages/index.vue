<template>
    ...
    <section class="mt-20 w-full flex flex-auto items-center justify-center">
        <div class="flex flex-wrap items-center justify-center gap-5 md:p-0 w-full p-2">
                <div class="bg-stone-100 w-96 h-full p-5 relative group transition-all">
                    ...
                    <img class="object-cover group-hover:scale-110 duration-500" src="/img/clock-product-1.png" alt="clock">
                    ...
                    <div class="mt-5 hidden group-hover:flex justify-center items-center">
                        <NuxtLink to="#" class="uppercase text-sm font-medium px-6 py-4 border border-yellow-800 hover:text-white hover:bg-black duration-500 delay-100 hover:border-black text-gray-800">
                            View More
                        </NuxtLink>
                    </div>
                </div>
                <div class="bg-stone-100 w-96 h-full p-5 relative group transition-all">
                    ...
                    <div class="absolute end-5 top-4">
                        <div class="font-medium text-xs rounded-full flex justify-center items-center size-12 uppercase text-white bg-yellow-800/70">SALE</div>
                    </div>
                    <img class="object-cover group-hover:scale-110 duration-500" src="/img/clock-product-2.png" alt="clock">
                    <div class="mt-5 space-y-4 flex flex-col justify-center items-center group-hover:hidden">
                        <span class="font-medium text-sm uppercase">Reprizo Gold Dial Watch</span>
                        <div class="flex items-center justify-center text-yellow-800">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
        ...
        <div class="md:h-[35rem] lg:h-[30rem] w-11/12 bg-stone-100 flex flex-col md:flex-row justify-around items-center p-4 relative">
                <div class="md:w-1/4 flex flex-col justify-around items-center h-full md:mr-auto mt-72 md:mt-auto space-y-6 md:space-y-0">
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="break-words mt-3 font-medium text-sm text-stone-400">
                            Run by the vibration of a quartz crystal (32,786 times per second) under current to keep accurate time.
                        </p>
                    </div>
                </div>
                ...
                <div class="md:w-1/4 flex flex-col justify-around items-center h-full space-y-6 md:space-y-0 mt-10 md:mt-auto">
                    <div class="flex flex-col">
    ...
    <section class="mt-16 lg:mt-28 w-full flex flex-col lg:flex-row justify-evenly lg:items-center gap-5">
        ...
        <div class="w-full lg:w-1/3 flex flex-col justify-around p-3 sm:p-7 lg:p-0">
                ...
                <p class="font-medium text-sm leading-loose break-words mt-5">
                    Attention to details is always a good feature. We couldn’t think of any better present for our 5th anniversary than a pair of exclusive watches from the Lawson collection. Every time I look at my watch I think of her and feel she thinks of me.
                </p>
                <div class="mt-10">
                    <NuxtLink to="#" class="uppercase text-sm font-medium px-6 py-4 border border-gray-500 hover:text-white hover:bg-black duration-500 delay-100 hover:border-black text-gray-800">
                        Read our story
